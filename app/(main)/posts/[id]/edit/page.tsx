     ...
     <div className="flex min-h-screen items-center justify-center bg-paper px-4 py-8">
      <div className="w-full max-w-2xl">
        <div className="mb-8 text-center">
          ...
          <h1 className="font-heading text-3xl font-normal text-ink">Study Mate</h1>
          <p className="mt-2 text-sm text-ink-soft">함께 성장하는 스터디 문화</p>
        </div>

        <Card className="bg-paper border-2 border-ink/15 shadow-soft p-6 md:p-8">
          <h2 className="mb-6 font-heading text-2xl font-normal text-ink">모집글 수정</h2>
