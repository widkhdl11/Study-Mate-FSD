     ...
     <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-muted/30 to-background px-4 py-8">
      <div className="w-full max-w-2xl">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl font-bold text-foreground">Study Mate</h1>
          <p className="mt-2 text-sm text-muted-foreground">함께 성장하는 스터디 문화</p>
        </div>

        <Card className="p-6 md:p-8">
          <h2 className="mb-6 text-2xl font-semibold text-foreground">모집글 수정</h2>
