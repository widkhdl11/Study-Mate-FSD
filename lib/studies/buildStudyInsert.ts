...
import { StudyCreateFormValues } from "../zod/schemas/studySchema";
type StudyInsert = TablesInsert<"studies">;
export function buildStudyInsert(validatedData: StudyCreateFormValues, userId: string): StudyInsert {
    return {
